...
for %%m in ( %PMP_PROJECT_MODULES% ) do (
    ...
    call .\pmp.bat
    set C1541_WRITE=!C1541_WRITE! -write "%%m\!PMP_PROJECT_TARGET!\!PMP_PROJECT_ARTIFACT_ID!.!PMP_PROJECT_PACKAGING!" "!PMP_PROJECT_ARTIFACT_ID!" !PMP_PACKAGER_DXX_ADDITIONAL_WRITES!
    popd
)
...
"%C1541%" -format "%C1541_DISKNAME%,%C1541_DISKID%" %PMP_PROJECT_PACKAGING% "%PMP_PROJECT_TARGET%\%C1541_IMAGE%" %C1541_WRITE%
